...
var changeModalState = function changeModalState(state) {
  ...
  bindActionToElems('change', windowProfile, 'typeProfile');
};
...
var forms = function forms(state, postPopupSelector) {
...
var timer = function timer(id, deadline) {
  ...
  var setClosk = function setClosk(selector, endTime) {

...
var modals = function modals() {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    var prevPopup = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : '';
  ...
  function bindCheckboxes(selectorWrapperCheckboxes) {
    var wrappers = document.querySelectorAll(selectorWrapperCheckboxes);
    var checkBoxes = document.querySelectorAll("".concat(selectorWrapperCheckboxes, " input"));
...
var tabs = function tabs() {
  function bindTabs(selectorTabs, selectorTabContents, selectorLink, activeClass, tabList) {
    var tabs = document.querySelectorAll(selectorTabs);

    function removeAllActiveClasses(selectorLink) {
      var links = document.querySelectorAll("".concat(selectorTabs, " ").concat(selectorLink));
    ...
    function hideAllTabContents(selectorTabContents) {
      var links = document.querySelectorAll(selectorTabContents);
      links.forEach(function (element) {
    ...
    tabs.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        var activeTabContentSelector = tabList[item.querySelector(selectorLink).classList[0]];
        ...
        var it = document.querySelector(".".concat(activeTabContentSelector));
  ...
  function tabPopupCalc() {
    var links = document.querySelectorAll('.balcon_icons_img'),
